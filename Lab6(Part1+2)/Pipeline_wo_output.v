...
input [1:0] thread;
   ...
   //Modification for part2
   wire [63:0] PC_plus_one_DUMMY_00;
   wire [63:0] PC_plus_one_DUMMY_01;
   wire [63:0] PC_plus_one_DUMMY_10;
   wire [63:0] PC_plus_one_DUMMY_11;
   //End of modification for part2 (For now !!)
   ...
   wire [63:0] PC_DUMMY;
   //Modification for part2
   wire [63:0] PC_DUMMY_00;
   wire [63:0] PC_DUMMY_01;
   wire [63:0] PC_DUMMY_10;
   wire [63:0] PC_DUMMY_11;
   //End of modification for part2 (For now !!)
   ...
   //Modification for part2
   wire [63:0] PC_next_DUMMY_00;
   wire [63:0] PC_next_DUMMY_01;
   wire [63:0] PC_next_DUMMY_10;
   wire [63:0] PC_next_DUMMY_11;
   //End of modification for part2 (For now !!)
   wire WME_EX_DUMMY;
...
// Software Registers (host -> FPGA)
   /*wire [63:0] machine_code_ins;
   assign Instr_IN = machine_code_ins;*/
...
//End of modification for part2 (For now !!)
   ...
   // Modification for Part2
   PC XLXI_00 (.clk(clk), 
              .PC_next(PC_next_DUMMY_00[63:0]), 
              .rst(rst), 
              .PC(PC_DUMMY_00[63:0]));
   PC XLXI_01 (.clk(clk), 
              .PC_next(PC_next_DUMMY_01[63:0]), 
              .rst(rst), 
              .PC(PC_DUMMY_01[63:0]));
   PC XLXIPC_10 (.clk(clk), 
              .PC_next(PC_next_DUMMY_10[63:0]), 
              .rst(rst), 
              .PC(PC_DUMMY_10[63:0]));
   PC XLXIPC_11 (.clk(clk), 
              .PC_next(PC_next_DUMMY_11[63:0]), 
              .rst(rst), 
              .PC(PC_DUMMY_11[63:0]));
   PC_MUX_00 XLXIMux_00 (.BTA(Offset_ID_DUMMY[63:0]), 
                  .PC_ctrl(PC_ctrl_DUMMY), 
                  .thread(thread),
                  .PC_next_in(PC_plus_one_DUMMY_00[63:0]), 
                  .PC_next_out(PC_next_DUMMY_00[63:0]));
   PC_MUX_01 XLXIMux_01 (.BTA(Offset_ID_DUMMY[63:0]), 
                  .PC_ctrl(PC_ctrl_DUMMY), 
                  .thread(thread),
                  .PC_next_in(PC_plus_one_DUMMY_01[63:0]), 
                  .PC_next_out(PC_next_DUMMY_01[63:0]));
   PC_MUX_10 XLXIMux_10 (.BTA(Offset_ID_DUMMY[63:0]), 
                  .PC_ctrl(PC_ctrl_DUMMY), 
                  .thread(thread),
                  .PC_next_in(PC_plus_one_DUMMY_10[63:0]), 
                  .PC_next_out(PC_next_DUMMY_10[63:0]));
   PC_MUX_11 XLXIMux_11 (.BTA(Offset_ID_DUMMY[63:0]), 
                  .PC_ctrl(PC_ctrl_DUMMY), 
                  .thread(thread),
                  .PC_next_in(PC_plus_one_DUMMY_11[63:0]), 
                  .PC_next_out(PC_next_DUMMY_11[63:0]));
	ThrMux_IF MuxIF (.Thread00(PC_DUMMY_00[63:0]),
	.Thread01(PC_DUMMY_01[63:0]),
	.Thread10(PC_DUMMY_10[63:0]),
	.Thread11(PC_DUMMY_11[63:0]),
	.thread(thread),
	.PC_Dummy(PC_DUMMY)
	);
   //End of modification for part2 (For now !!)
   ...
   */
   ...
   //Modification for part2
   PC_plus_1 XLXIplus1_00 (.ONE(ONE[63:0]), // ONE?
                      .PC(PC_DUMMY_00[63:0]), 
                      .PC_next(PC_plus_one_DUMMY_00[63:0]));
   PC_plus_1 XLXIplus1_01 (.ONE(ONE[63:0]), 
                      .PC(PC_DUMMY_01[63:0]), 
                      .PC_next(PC_plus_one_DUMMY_01[63:0]));
   PC_plus_1 XLXIplus1_10 (.ONE(ONE[63:0]), 
                      .PC(PC_DUMMY_10[63:0]), 
                      .PC_next(PC_plus_one_DUMMY_10[63:0]));
   PC_plus_1 XLXIplus1_11 (.ONE(ONE[63:0]), 
                      .PC(PC_DUMMY_11[63:0]), 
                      .PC_next(PC_plus_one_DUMMY_11[63:0]));
   //End of modification for part2 (For now !!)
